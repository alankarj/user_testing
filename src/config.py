...
INFORMABLE_SLOTS_PLACEHOLDERS = [GENRE_PLACEHOLDER, '#DIRECTOR', ACTOR_PLACEHOLDER]
INF_PLACEHOLDER_DICT = dict(zip(INFORMABLE_SLOTS, INFORMABLE_SLOTS_PLACEHOLDERS))
